...
import com.codecool.filepartreaderpatrick.FilePartReader;
...
public class FilePartReaderTest {
        ...
        @Test
        @DisplayName("Tests whether calling setup() with fromLine argument less than 1 throws a IllegalArgumentException")
        ...
        void testReadLines1_2() throws IOException {
            this.filePartReader.setup("test_data", 1, 2);
            assertEquals("1a1\n" +
        ...
        void testReadLines2_4() throws IOException {
            this.filePartReader.setup("test_data", 2, 4);
            assertEquals("2b 2a\n" +
                    "3c 3b 3a\n" +
                    "4d 4cr 4bb4 4a\n", this.filePartReader.readLines());
        }
        ...
        void testReadLinesAll() throws IOException {
            this.filePartReader.setup("test_data", 1, 7);
            String excepted = "1a1\n" +
                    "2b 2a\n" +
                    "3c 3b 3a\n" +
                    "4d 4cr 4bb4 4a\n" +
        ...
        void testReadLinesPastEof() throws IOException {
            this.filePartReader.setup("test_data", 1, 9999);
