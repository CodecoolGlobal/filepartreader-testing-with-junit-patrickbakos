...
import com.codecool.filepartreaderpatrick.*;
...
class FileWordAnalyzerTest {
    ...
    void testWordsContainingSubStringLine2_4() throws IOException {
        ...
        assertEquals(excepted, this.fileWordAnalyzer.getWordsContainingSubstring("4"));
    }
    ...
    void testWordsContainingSubStringResultEmpty() throws IOException {
        this.fileWordAnalyzer.getFilePartReader().setup("test_data", 1, 1);
        assertEquals(new ArrayList<>(), this.fileWordAnalyzer.getWordsContainingSubstring("loremipsum_not_In"));
    }
    ...
    void testWordsArePalindromeAllResults() throws IOException {
        this.fileWordAnalyzer.getFilePartReader().setup("test_data", 1, 7);
        ArrayList<String> excepted = new ArrayList<>(Arrays.asList("1a1", "4bb4"));
        assertEquals(excepted, this.fileWordAnalyzer.getStringsWhichPalindromes());
    }
